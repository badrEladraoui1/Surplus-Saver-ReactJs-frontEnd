...
import AddNweAdmin from "./AddNewAdmin";
...
const AdminLoginPage = () => {
  ...
  useEffect(() => {
    ...
    if (storedToken) {
      ...
      if (role === "ROLE_ADMIN") navigate("/admin/choices");
    }
  }, [navigate]);
  ...
  const onSubmit = async (data) => {
    try {
      ...
      setSuccessMessage(
        "Sign in successful. Redirecting you to the admin page..."
  ...
  return (
    <section className="flex flex-col justify-center items-center p-10 gap-10 ">
      <div>
        <AddNweAdmin className />
      </div>
      <h1 className="text-6xl font-bold gap-5">Admin Page</h1>
